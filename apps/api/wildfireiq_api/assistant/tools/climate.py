...
@tool(
    ...
    parameters={
        ...
        "properties": {
            ...
            "rank_by": {
                "type": "string",
                "description": "Return the years ranked by this metric, worst first, instead of chronologically.",
            },
            "top_n": {"type": "integer", "description": "With rank_by, how many years. Default 5."},
        },
    },
    ttl_s=3600,
    tags=("climate",),
    ...
    parameters={
        ...
        "properties": {
            **LOCATION_PROPERTIES,
            ...
            "min_hectares": {"type": "number", "description": "Ignore fires smaller than this."},
            "limit": {"type": "integer", "description": "Largest incidents to list (max 15)."},
        },
    },
    ttl_s=3600,
    tags=("climate", "fires"),
