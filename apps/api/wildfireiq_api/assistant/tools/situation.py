    ...
    parameters={
        ...
        "properties": {
            **LOCATION_PROPERTIES,
            "within_km": {
                "type": "number",
                "description": "Radius around the location. Ignored when no location is given.",
            },
            "min_hectares": {"type": "number", "description": "Drop incidents smaller than this."},
            "sort_by": {
                "type": "string",
                "enum": ["distance", "size", "newest"],
                "description": "Ordering of the returned incidents. Defaults to distance when a location is given, otherwise size.",
            },
            "limit": {"type": "integer", "description": "How many incidents to return (max 25)."},
        },
    },
    ttl_s=120,
    tags=("fires",),
...
@tool(
    ...
    parameters={
        ...
        "properties": {
            **LOCATION_PROPERTIES,
            "hours": {"type": "integer", "description": "Look-back window, 1-168. Default 24."},
...
@tool(
    ...
    parameters={
        ...
        "properties": {
            ...
            "include_rescinded": {
                "type": "boolean",
                "description": "Include zones already stood down. Default false.",
            },
            "limit": {"type": "integer", "description": "Max zones to return (max 30)."},
        },
    },
    ttl_s=60,
    tags=("evac", "safety"),
